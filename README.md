...
1. **그 조건이기 때문에 어떤 인공지능을 선택했는가? / 해당 인공지능을 우리의 상황에 적용하기 위해서는 어떤 노력을 해야하는가?**
